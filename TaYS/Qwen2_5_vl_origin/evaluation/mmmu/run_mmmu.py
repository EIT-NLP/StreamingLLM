...
def main():
    ...
    infer_parser.add_argument(
        "--model-path",
        type=str,
        default="/code/Streaming_video/pe_version/Qwen2_5_vl_origin/qwen-vl-finetune/output/qwen2_5vl-pe-origin-waitkey-random-20k",
    ...
    infer_parser.add_argument(
        "--output-file",
        type=str,
        default="/code/Streaming_video/pe_version/Qwen2_5_vl_origin/evaluation/mmmu/output/PE-origin-waitkey-random-20k.json",
