...
from .causal_mask_CoT import build_group_custom_causal_mask
    ...
    def _update_causal_mask(
        ...
        try:
            ...
            causal_mask = build_group_custom_causal_mask(
                ...
                dtype=dtype,
                use_random_wait_k=self.use_random_wait_k,
                use_random_frame_chunk=self.use_random_frame_chunk,
            )
        except:
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        if hasattr(self, "randK") and self.randK:
            self.model.use_random_wait_k = True
        else:
            self.model.use_random_wait_k = False

        if hasattr(self, "randF") and self.randF:
            self.model.use_random_frame_chunk = True
        else:
            self.model.use_random_frame_chunk = False
