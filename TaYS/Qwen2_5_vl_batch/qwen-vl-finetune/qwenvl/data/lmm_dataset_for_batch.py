...
class LMMDataset(Dataset):
    ...
    def getitem(self, index):
        ...
        rewrited_evidence = sample["rewrited_evidence"].strip()
        video_start = 0.0
        ...
        # <answer>       151667
        # </answer>      151668
        # SPECIAL_TOKEN_IDS = [151665, 151666, 151667, 151668]
        # if sample["answer"]:
...
if __name__ == "__main__":
    ...
    dataset = LMMDataset(
        annotation_paths=[
            ...
            # "/code/chr/download/PE-Video/train_combined_token_4_8_human_caption.jsonl",
            # 'llava_video_178k_with_seeks.jsonl',
            # 'llava_hound_video_with_seeks.jsonl',
            # 'llava_ov_multi_image_with_seeks.jsonl',
            # 'llava_ov_single_image_text_mix_with_seeks.jsonl'
