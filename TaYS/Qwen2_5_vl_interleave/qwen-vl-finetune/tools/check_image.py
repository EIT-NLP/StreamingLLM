...
if __name__ == "__main__":
    json_file_path = "/code/Streaming_video/data/LLaVA-Video-178K/0_30_s_academic_v0_1/0_30_s_academic_v0_1_cap_processed.json"  # Replace with your JSON file path
    media_folder_path = "/code/chr/download/LLaVA-Video/LLaVA-Video-178K/0_30_s_academic_v0_1"  # Replace with your media folder path
