...
# Model configuration
if [ -d "../../../../model/Qwen2.5-VL-3B-Instruct" ]; then
    llm=../../../../model/Qwen2.5-VL-3B-Instruct  # Using local model
else
...
run_name="qwen2_5vl-interleave-CoT"
output_dir=./output/qwen2_5vl-interleave-CoT-3B-$(date +"%Y%m%d_%H%M")
