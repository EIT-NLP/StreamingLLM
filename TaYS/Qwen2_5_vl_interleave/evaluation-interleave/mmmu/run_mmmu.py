...
def main():
    ...
    infer_parser.add_argument(
        "--model-path",
        type=str,
        default="/code/code/video_streaming/Qwen2_5_vl_interleave/qwen-vl-finetune/output/qwen2_5vl-pe-interleave-randK-randF",
    ...
    infer_parser.add_argument(
        "--output-file",
        type=str,
        default="/code/code/video_streaming/Qwen2_5_vl_interleave/evaluation-interleave/mmmu/output/qwen2_5vl-pe-interleave-randK-randF-0821.jsonl",
